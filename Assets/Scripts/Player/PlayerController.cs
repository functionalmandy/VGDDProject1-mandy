...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator UseAttack(PlayerAttackInfo attack)
    {
        ...
        IEnumerator toColor = (IEnumerator)ChangeColor(attack.AbilityColor, 10);
        ...
        StartCoroutine((IEnumerator)ChangeColor(p_DefaultColor, 50));
    ...
    #region Misc Methods
    private IEnumerable ChangeColor(Color newColor, float speed)
    {
